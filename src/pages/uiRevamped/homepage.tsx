...
import { Category, Embedding, FetchCategories, FetchEmebeddingbyCategory } from "../../components/dbFunctions/fetchCategories";
...
export const Homepage = () => {
    ...
    const HandleEmbedding=async(id:string)=>{
                        ...
                        <section
                            ...
                            {categories.map((category) => (
                                <Card
                                    ...
                                    onClick={()=>HandleEmbedding(category._id)}
                                    >
                                    <Heading
                                        onClick={() => {
